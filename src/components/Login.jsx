...
//         // Fetch additional user details using the obtained token
//         const userResponse = await fetch('https://fakestoreapi.com/users/' + json.userId, {
//           headers: {
...
//         // Use the user information directly from the user details response
//         const loggedInUser = {
//           id: json.userId,
//           username: formData.username,
